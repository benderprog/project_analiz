...
ANALYSIS_TASK_SOFT_TIME_LIMIT = int(os.getenv("ANALYSIS_TASK_SOFT_TIME_LIMIT", os.getenv("WORKER_SOFT_TIME_LIMIT", "1020")))
ANALYSIS_TASK_TIME_LIMIT = int(os.getenv("ANALYSIS_TASK_TIME_LIMIT", os.getenv("WORKER_TIME_LIMIT", "1080")))
