...
- `configs/portal.yml` (and `configs/portal/portal.yml`)
- `configs/portal/sql/...`
...
1. Edit SQL files under `configs/portal/sql/`.
2. If needed, remap query filenames in `configs/portal.yml` (or `configs/portal/portal.yml`).
